...
function f1() {
  ...
  out1.textContent = 4 == input1.value;
}
...
function f3() {
  ...
  if (Number(input31.value) > Number(input32.value)) {
...
function f4() {
  ...
  if (Number(input4.value) < 0) {
    out4.textContent = " Щось дивне...";
    return;
  }
  if (2026 - Number(input4.value) < 18) {
    out4.textContent = 0;
  } else {
    out4.textContent = 1;
  }
...
function f5() {
  ...
  if (Number(input5.value) < 0) {
    out5.textContent = "m";
  } else if (Number(input5.value) === 0) {
    out5.textContent = 0;
  } else {
    out5.textContent = 1;
  }
...
function f6() {
  ...
  out6.textContent = Number(input6.value) % 2 === 0 ? "even" : "odd";
}
...
function f13() {
  ...
  const a = input130.value;
  out13.textContent = typeof a;
}
...
function f14() {
  ...
  switch (select143.value) {
    ...
    case "/":
      out14.textContent = (
        Number(input141.value) / Number(input142.value)
      ).toFixed(2);
      break;
  }
}
...
function f15() {
  ...
  switch (select153.value) {
    case "&&":
      out15.textContent = Number(select151.value) && Number(select152.value);
      break;
    case "||":
      out15.textContent = Number(select151.value) || Number(select152.value);
      break;
